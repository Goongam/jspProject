...
public class UploadSummernoteImageFile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MultipartRequest multi = new MultipartRequest(request, fileRoot, 5 * 1024 * 1024, "UTF-8",
		...
		// json.put("url",
		// request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/uploadImgs/"+savedFileName);
