...
public class QuestionDTO {
	...
	/*
	 * `id` INT NOT NULL AUTO_INCREMENT, `title` VARCHAR(45) NOT NULL, `content`
	 * TEXT NOT NULL, `member_id` VARCHAR(45), `anonymous` VARCHAR(45) NULL,
	 * `category` INT NULL, `views` VARCHAR(45) NOT NULL, `edit_time` TIMESTAMP NOT
	 * NULL,
	 * 
	 */
}
