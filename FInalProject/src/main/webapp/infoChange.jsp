...
<body>
	<div
		style="width: 400px; margin: auto; border-radius: 0.5rem; box-shadow: 0.2rem 0.30rem 0.2rem -0.12rem rgba(0, 0, 0, 0.45);">
		<div style="text-align: center;">
			<a href="index.do"> <img src="imgs/banner.png"><br>
			</a>
			<h2 style="font-size: 18px; color: #6A24FE;">회원 정보 변경</h2>
		</div>
		<form action="change.do" method="post" id="changeForm">
			<div>
				<b class="input_label">닉네임 변경</b><br> <input class="text"
					type="text" name="changeNickname" placeholder="닉네임"
					value="<%out.println(session.getAttribute("nickName"));%>"><br>
				<br>
			</div>
			<div>
				<b class="input_label">비밀번호 변경</b><br> <input class="text"
					type="password" name="changePw" id="user_pass" placeholder="패스워드"><br>
				<br>
			</div>
			<div>
				<b class="input_label">비밀번호 확인</b><br> <input class="text"
					type="password" name="changePwCheck" id="chpass"
					placeholder="패스워드확인"><br> <font name="check" size="2"
					color="red"></font> <br>
				<br>
			</div>
			<div>
				<b class="input_label">프로필 이미지 변경</b> <br> <input class="text"
					type="text" name="changeProfileImg" placeholder="이미지 주소"
					id="img_url_input" value="<%=session.getAttribute("profileImg")%>"
					style="width: 230px;" hidden><input type="file"
					value="찾아보기" style="margin-left: 5px;" id="profile_img_input"><br>
				<br>
			</div>
			<div>
			...
			<br> <input type="submit" class="sign_up" value="회원정보 변경"
				style="margin-bottom: 20px; color: white;"></input>
		</form>
	</div>
