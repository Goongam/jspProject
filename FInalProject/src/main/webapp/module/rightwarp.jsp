...
<%
			...
			<div id="mypage_btn" class="border">
                ...
                <% 
					...
					%>
					<button onclick="myPagein()" style="background-color: rgb(4,125,147); width: 230.8px; height: 80px; margin-top: 10px; border: 0 solid; color: white; border-radius: 0.5rem;
        box-shadow: 0.05rem 0.1rem 0.3rem -0.03rem rgba(0, 0, 0, 0.45); margin-left: 0px;">
